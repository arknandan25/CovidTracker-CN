...
message ="\nUpdate number:"+str(random.randint(0,2000))+".\nRegarding:User grocery analysis\nLearnt user buying - 12% organic vegetables,45% dairy products, 10% packaged food, 33% frozen food items."
